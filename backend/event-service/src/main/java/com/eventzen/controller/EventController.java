...
public class EventController {
    ...
    @Operation(summary = "Create event publicly", description = "Create a new event without authentication (for testing)")
    public ResponseEntity<Event> createEventPublic(@Valid @RequestBody Event event) {
        // Set a default organizer ID for testing
        event.setOrganizerId("test-organizer");
        return ResponseEntity.ok(eventService.createEvent(event));
    }
}